decks_map = {
    ...
    "Poison Storm": {
        ...
        "cards": {
            ...
            "Prologue to Phyresis": [
                {"qty": 1, "code": "ONE - 65", "section": "main"},
            ],
            "Snap": [
                {"qty": 3, "code": "DMR - 66", "section": "main"},
            ],
            "Steady Progress": [
                {"qty": 3, "code": "SOM - 45", "section": "main"},
            ],
            "Weather the Storm": [
                {"qty": 4, "code": "H1R - 24", "section": "main"},
            ],
            "Contentious Plan": [
                {"qty": 4, "code": "WAR - 46", "section": "main"},
            ],
            "Infectious Inquiry": [
                {"qty": 4, "code": "ONE - 97", "section": "main"},
            ],
            "Lórien Revealed": [
                {"qty": 4, "code": "LTR - 60", "section": "main"},
            ],
            "Thirsting Roots": [
                {"qty": 4, "code": "ONE - 185", "section": "main"},
            ],
            ...
            "Sandstone Needle": [
                {"qty": 2, "code": "MM - 326", "section": "main"},
            ],
            "Peat Bog": [
                {"qty": 2, "code": "MM - 322", "section": "main"},
            ],
            "Saprazzan Skerry": [
                {"qty": 4, "code": "MM - 328", "section": "main"},
            ],
            "Snow-Covered Forest": [
                {"qty": 1, "code": "MM - 254", "section": "main"},
            ],
            "Snow-Covered Mountain": [
                {"qty": 1, "code": "MH1 - 253", "section": "main"},
            ],
            "Snow-Covered Swamp": [
                {"qty": 1, "code": "MM - 252", "section": "main"},
            ],
            "Snow-Covered Island": [
    ...
    "Jund Wildfire": {
        ...
        "cards": {
            ...
            "Mountain": [
                {"qty": 1, "code": "FEFBB - 222", "section": "main"},
            ],
            "Swamp": [
                {"qty": 3, "code": "FEFBB - 311", "section": "main"},
            ],
            "Forest": [
                {"qty": 1, "code": "FEFBB - 127", "section": "main"},
                {"qty": 1, "code": "FEFBB - 128", "section": "main"},
            ],
            "Vault of Whispers": [
    ...
    "Mono U Snakes": {
        ...
        "cards": {
            "Cryptic Serpent": [
                {"qty": 4, "code": "CMM - 83", "section": "main"},
            ],
            "Tolarian Terror": [
                {"qty": 4, "code": "DMU - 72", "section": "main"},
            ],
            "Delver of Secrets // Insectile Aberration": [
                {"qty": 4, "code": "ISD - 51", "section": "main"},
            ],
            "Brainstorm": [
                {"qty": 4, "code": "SS1 - 3", "section": "main"},
            ],
            "Counterspell": [
                {"qty": 4, "code": "IA - 64", "section": "main"},
            ],
            "Mental Note": [
                {"qty": 4, "code": "JUD - 46", "section": "main"},
            ],
            "Thought Scour": [
                {"qty": 4, "code": "IMA - 76", "section": "main"},
            ],
            "Lórien Revealed": [
                {"qty": 4, "code": "LTR - 60", "section": "main"},
            ],
            "Ponder": [
                {"qty": 3, "code": "LRW - 79", "section": "main"},
            ],
            "Sleep of the Dead": [
                {"qty": 2, "code": "THB - 66", "section": "main"},
            ],
            "Spell Pierce": [
                {"qty": 2, "code": "XLN - 81", "section": "main"},
            ],
            "Consider": [
                {"qty": 1, "code": "MKC - 98", "section": "main"},
            ],
            "Deem Inferior": [
                {"qty": 2, "code": "MH3 - 57", "section": "main"},
            ],
            "Deep Analysis": [
                {"qty": 2, "code": "EMA - 45", "section": "main"},
            ],
            "Snow-Covered Island": [
    ...
    "Mono U Faeries": {
        ...
        "cards": {
            "Faerie Miscreant": [
                {"qty": 4, "code": "ORI - 57", "section": "main"},
            ],
            "Faerie Seer": [
            ...
            "Harrier Strix": [
                {"qty": 2, "code": "OTJ - 52", "section": "main"},
            ],
            "Saiba Cryptomancer": [
                {"qty": 1, "code": "MOM - 76", "section": "main"},
            ],
            "Force Spike": [
                {"qty": 2, "code": "DDJ - 14", "section": "main"},
            ],
            "Spell Pierce": [
                {"qty": 2, "code": "XLN - 81", "section": "main"},
            ],
            ...
            "Of One Mind": [
                {"qty": 4, "code": "IKO - 60", "section": "main"},
            ],
            "Island": [
                {"qty": 18, "code": "ELD - 257", "section": "main"},
            ],
            "Steel Sabotage": [
                {"qty": 1, "code": "MBS - 33", "section": "sideboard"},
            ],
            "Annul": [
                {"qty": 3, "code": "KHM - 42", "section": "sideboard"},
            ],
            "Dispel": [
                {"qty": 1, "code": "RTR - 36", "section": "sideboard"},
            ],
            "Blue Elemental Blast": [
                {"qty": 1, "code": "2U - 50", "section": "sideboard"},
